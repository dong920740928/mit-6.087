...
{
    struct student *s_a = (struct student*)a;
    struct student *s_b = (struct student*)b;

    return strcmp(s_a->fname, s_b->fname);
}
...
*/ int compare_last_name(const void* a, const void* b) { struct student *s_a = (struct student*)a; struct student *s_b = (struct student*)b;

    return strcmp(s_a->lname, s_b->lname);
}
...
{
    struct student *pstud = (struct student*)prec;
    int *age_bound = (int*)arg;
    if (pstud->age > *age_bound){
        printrec(prec, arg);
    }
}
